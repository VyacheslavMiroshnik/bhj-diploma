...
class TransactionsPage {
  ...
  removeAccount() {
    if (this.lastOptions) {
      ...
      if (window.confirm("Вы точно хотите удалить счет?")) {
  ...
  removeTransaction(id) {
    if (window.confirm("Вы точго хотите удалить транзакцию?")) {
  ...
  clear() {
    ...
    this.renderTitle("Названия счета");
  }
  ...
  formatDate(date) {
    ...
    return (
      transactionDate.toLocaleString("ru", {
        year: "numeric",
        month: "long",
        day: "numeric",
      }) +
